...
<div class="tab-content" >
  <div id="home1" class="tab-pane fade in active col-md-6">
    ...
    <div class="col-xs-5">
    <label for="idbaja">Insert the SOS that you want to delete	</br></label>
  ...
  <div id="menu2" class="tab-pane fade">
		<div id="home1" class="tab-pane fade in active col-md-6">
			...
			<div class="form-group">
				...
				<label for="idbaja">Insert the SOS that you want to update	</br></label>
				<input type="text" class="form-control" placeholder="SOS" id="idbaja" autofocus>
				<label for="name">Name:</label>
				<input type="text" class="form-control" id="name">
				<label for="fechaini">Begin Date:</label>
  ...
  <div id="menu3" class="tab-pane fade">
		...
		<div class="col-xs-5">
		<label for="idbaja">Insert the SOS that you want to consult	</br></label>
		<input type="text" class="form-control" placeholder="SOS" id="idbaja" autofocus>
			</div>
  </div>
