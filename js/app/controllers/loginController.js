 ...
 define([], function( ){
   return function($http,$scope){
     ...
     $scope.email=function (){
         ...
         swal({
             title: "New User!",
             text: 'Write your email!', //Write a e-mail
             type: 'input',
             ...
             if (email === false||email === "" ||!/^\w*\.\w*@\w*\.com$/.test(email)) //new if
